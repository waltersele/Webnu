...
$dishImages = [
    ...
    'cocktail-mojito.jpg' => 'https://images.pexels.com/photos/5946962/pexels-photo-5946962.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&fit=crop',
    ...
    'cocktail-whiskey.jpg' => 'https://images.pexels.com/photos/5946962/pexels-photo-5946962.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&fit=crop',
    ...
    'fuego-tonkotsu.jpg' => 'https://images.pexels.com/photos/6642470/pexels-photo-6642470.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
...
$demoVideos = [
    'demo/reel-01.mp4' => 'https://videos.pexels.com/video-files/3209663/3209663-sd_640_360_25fps.mp4',
    'demo/reel-02.mp4' => 'https://videos.pexels.com/video-files/3942588/3942588-sd_640_360_25fps.mp4',
    'demo/reel-03.mp4' => 'https://videos.pexels.com/video-files/3129671/3129671-sd_640_360_30fps.mp4',
    'demo/reel-04.mp4' => 'https://videos.pexels.com/video-files/855325/855325-sd_640_360_25fps.mp4',
    'demo/reel-cocktail.mp4' => 'https://videos.pexels.com/video-files/3942588/3942588-sd_640_360_25fps.mp4',
    'demo/reel-steak.mp4' => 'https://videos.pexels.com/video-files/3209663/3209663-sd_640_360_25fps.mp4',
    'demo/reel-kitchen.mp4' => 'https://videos.pexels.com/video-files/3129671/3129671-sd_640_360_30fps.mp4',
];
...
$restaurantDishes = [
    ...
    ['section' => 'Principales', 'name' => 'Solomillo al Pedro Ximénez', 'description' => 'Solomillo de ternera, reducción de Pedro Ximénez, patata confitada y verduras de temporada.', 'price' => '24.50', 'image' => 'brasa-solomillo.jpg', 'allergens' => ['Sulfitos'], 'highlight' => 'bestseller', 'video' => 'demo/reel-steak.mp4'],
    ['section' => 'Principales', 'name' => 'Lubina a la espalda', 'description' => 'Lubina salvaje, refrito de ajos tiernos, guindilla y guarnición de verduras de la huerta.', 'price' => '22.00', 'image' => 'brasa-lubina.jpg', 'allergens' => ['Pescados'], 'video' => 'demo/reel-03.mp4'],
    ...
    ['section' => 'Postres', 'name' => 'Brownie con helado', 'description' => 'Chocolate 70 %, helado artesano de vainilla y crumble de avellanas.', 'price' => '7.00', 'image' => 'brasa-brownie.jpg', 'allergens' => ['Gluten', 'Lácteos', 'Huevos', 'Frutos secos'], 'video' => 'demo/reel-kitchen.mp4'],
];

$cocktailDishes = [
    ['section' => 'Signature', 'name' => 'Negroni del Puerto', 'description' => 'Gin mediterráneo, vermut rojo, bitter de naranja y piel de cítricos flameada.', 'price' => '11.00', 'image' => 'cocktail-negroni.jpg', 'allergens' => ['Sulfitos'], 'highlight' => 'featured', 'video' => 'demo/reel-cocktail.mp4'],
    ['section' => 'Signature', 'name' => 'Margarita de autor', 'description' => 'Tequila reposado, triple sec, lima fresca y sal ahumada en el copo.', 'price' => '10.50', 'image' => 'cocktail-margarita.jpg', 'allergens' => [], 'highlight' => 'featured', 'video' => 'demo/reel-02.mp4'],
    ['section' => 'Clásicos', 'name' => 'Mojito de hierbabuena', 'description' => 'Ron blanco, hierbabuena fresca, lima, azúcar de caña y soda.', 'price' => '9.00', 'image' => 'cocktail-mojito.jpg', 'allergens' => ['Sulfitos'], 'highlight' => 'featured', 'video' => 'demo/reel-cocktail.mp4'],
    ['section' => 'Clásicos', 'name' => 'Gin tonic mediterráneo', 'description' => 'Gin botánico, tónica premium, romero y cáscara de pomelo.', 'price' => '9.50', 'image' => 'cocktail-gintonic.jpg', 'allergens' => ['Sulfitos'], 'highlight' => 'featured', 'video' => 'demo/reel-04.mp4'],
    ['section' => 'Clásicos', 'name' => 'Old Fashioned', 'description' => 'Bourbon, bitter aromatic, azúcar y twist de naranja. Servido en roca.', 'price' => '11.50', 'image' => 'cocktail-whiskey.jpg', 'allergens' => [], 'highlight' => 'featured', 'video' => null],
];

$fuegoDishes = [
    ['section' => '前菜 · Entrantes', 'name' => 'Gyozas 餃子', 'description' => '🇪🇸 Empanadillas asiáticas a la plancha. Relleno de cerdo o verduras. 📍 Manchuria, China 🇨🇳', 'price' => '3.95', 'image' => 'fuego-gyozas.jpg', 'allergens' => ['Gluten', 'Soja'], 'highlight' => 'featured', 'video' => 'demo/reel-01.mp4'],
    ['section' => '前菜 · Entrantes', 'name' => 'Tori no Karaage 唐揚げ', 'description' => '🇪🇸 Pollo frito japonés. Marinado en jengibre, soja y mirin. 📍 Beppu, Japón 🇯🇵', 'price' => '4.95', 'image' => 'fuego-karaage.jpg', 'allergens' => ['Gluten', 'Soja'], 'video' => 'demo/reel-kitchen.mp4'],
    ['section' => '前菜 · Entrantes', 'name' => 'Yakitori 焼き鳥', 'description' => '🇪🇸 Brochetas a la brasa. Pollo campero o vaca gallega madurada. 📍 Tokyo, Japón 🇯🇵', 'price' => '4.95', 'image' => 'fuego-yakitori.jpg', 'allergens' => ['Soja'], 'highlight' => 'bestseller', 'video' => 'demo/reel-steak.mp4'],
    ['section' => '麺 · Ramen', 'name' => 'Tonkotsu Ramen 豚骨', 'description' => '🇪🇸 Caldo de cerdo estilo Yokohama. Huevo macerado, brotes de bambú y cebollino. PEQUEÑO 9,95 € · GRANDE 11,95 €. 📍 Yokohama, Japón 🇯🇵', 'price' => '11.95', 'image' => 'fuego-tonkotsu.jpg', 'allergens' => ['Gluten', 'Soja', 'Huevos'], 'highlight' => 'bestseller', 'video' => 'demo/reel-steak.mp4'],
    ['section' => '麺 · Ramen', 'name' => 'Haek Buldak Ramen 🔥🇰🇷', 'description' => '🇪🇸 Ramen seco con salsa picante nuclear. Carne picada, huevo poché y verduras frescas. 📍 Seúl, Corea del Sur 🇰🇷', 'price' => '11.95', 'image' => 'fuego-buldak.jpg', 'allergens' => ['Gluten', 'Soja', 'Huevos'], 'highlight' => 'featured', 'video' => 'demo/reel-03.mp4'],
    ['section' => '甘味 · Dulces', 'name' => 'Mochi Matcha 抹茶大福', 'description' => 'Masa gyuhi casera con mousse de matcha ceremonial y corazón de fresa. 📍 Receta propia ㊙️', 'price' => '5.95', 'image' => 'fuego-mochi.jpg', 'allergens' => ['Lácteos'], 'highlight' => 'new', 'video' => 'demo/reel-04.mp4'],
];

$japoDishes = [
    ['section' => '前菜 · Entradas', 'name' => 'Edamame 枝豆', 'description' => 'Vainas de soja al vapor con sal de mar. 📍 Kyoto, Japón 🇯🇵', 'price' => '4.50', 'image' => 'fuego-gyozas.jpg', 'allergens' => ['Soja'], 'video' => 'demo/reel-01.mp4'],
    ['section' => '前菜 · Entradas', 'name' => 'Sashimi del día 刺身', 'description' => 'Selección de pescado fresco del mercado. Wasabi y jengibre encurtido. 📍 Tsukiji, Japón 🇯🇵', 'price' => '14.50', 'image' => 'brasa-lubina.jpg', 'allergens' => ['Pescados', 'Soja'], 'highlight' => 'featured', 'video' => 'demo/reel-03.mp4'],
    ['section' => '丼 · Arroz', 'name' => 'Gyudon 牛丼', 'description' => 'Bol de arroz con ternera, cebolla y salsa dashi. Huevo poché y shichimi. 📍 Tokio, Japón 🇯🇵', 'price' => '8.50', 'image' => 'brasa-arroz-setas.jpg', 'allergens' => ['Gluten', 'Soja', 'Huevos'], 'highlight' => 'bestseller', 'video' => 'demo/reel-kitchen.mp4'],
    ['section' => '温 · Caliente', 'name' => 'Miso Ramen 味噌', 'description' => 'Caldo tonkotsu con pasta de miso, chashu, repollo chino y huevo macerado. 📍 Hokkaido, Japón 🇯🇵', 'price' => '11.95', 'image' => 'fuego-tonkotsu.jpg', 'allergens' => ['Gluten', 'Soja', 'Huevos'], 'video' => 'demo/reel-steak.mp4'],
    ['section' => '甘 · Dulce', 'name' => 'Mochi de té verde', 'description' => 'Daifuku casero con matcha ceremonial. 📍 Receta propia ㊙️', 'price' => '5.50', 'image' => 'fuego-mochi.jpg', 'allergens' => ['Lácteos'], 'video' => 'demo/reel-04.mp4'],
];

$fastfoodDishes = [
    ['section' => 'Combos', 'name' => 'Menú Smash', 'description' => 'Smash burger clásico + patatas crujientes + refresco 33 cl.', 'price' => '11.90', 'image' => 'fastfood-combo.jpg', 'allergens' => ['Gluten', 'Lácteos'], 'highlight' => 'bestseller', 'video' => 'demo/reel-steak.mp4'],
    ['section' => 'Combos', 'name' => 'Menú Crispy', 'description' => 'Pollo crujiente + patatas + salsa a elegir.', 'price' => '10.90', 'image' => 'fastfood-chicken.jpg', 'allergens' => ['Gluten', 'Huevos'], 'highlight' => 'featured', 'video' => 'demo/reel-01.mp4'],
    ['section' => 'Burgers', 'name' => 'Double Smash', 'description' => 'Doble carne smash, cheddar fundido, pepinillos y salsa house.', 'price' => '8.90', 'image' => 'fastfood-smash.jpg', 'allergens' => ['Gluten', 'Lácteos'], 'highlight' => 'bestseller', 'video' => 'demo/reel-kitchen.mp4'],
    ['section' => 'Burgers', 'name' => 'BBQ Bacon', 'description' => 'Bacon crujiente, cebolla caramelizada y salsa BBQ ahumada.', 'price' => '9.90', 'image' => 'fastfood-bacon.jpg', 'allergens' => ['Gluten', 'Lácteos'], 'video' => 'demo/reel-steak.mp4'],
    ...
    ['section' => 'Extras', 'name' => 'Nuggets x6', 'description' => 'Pollo crujiente. Elige BBQ, honey mustard o spicy.', 'price' => '5.50', 'image' => 'fastfood-chicken.jpg', 'allergens' => ['Gluten'], 'video' => 'demo/reel-04.mp4'],
    ['section' => 'Bebidas', 'name' => 'Milkshake vainilla', 'description' => 'Batido cremoso con helado artesano. También chocolate o fresa.', 'price' => '4.20', 'image' => 'fastfood-shake.jpg', 'allergens' => ['Lácteos'], 'video' => null],
];

$marDishes = [
    ['section' => 'Del mar', 'name' => 'Lubina a la espalda', 'description' => 'Lubina salvaje, refrito de ajos tiernos y guindilla.', 'price' => '22.00', 'image' => 'brasa-lubina.jpg', 'allergens' => ['Pescados'], 'highlight' => 'bestseller', 'video' => 'demo/reel-03.mp4'],
    ['section' => 'Del mar', 'name' => 'Gambas al ajillo', 'description' => 'Gambas rojas de Vinaròs, ajo confitado y guindilla.', 'price' => '16.50', 'image' => 'brasa-lubina.jpg', 'allergens' => ['Crustáceos'], 'highlight' => 'featured', 'video' => 'demo/reel-04.mp4'],
    ['section' => 'Del mar', 'name' => 'Arroz meloso de mar', 'description' => 'Arroz bomba con caldo de pescado, sepia y alioli.', 'price' => '19.00', 'image' => 'brasa-arroz-setas.jpg', 'allergens' => ['Pescados', 'Crustáceos', 'Gluten'], 'video' => 'demo/reel-kitchen.mp4'],
...
$eleganceDishes = [
    ...
    ['section' => 'Entrantes', 'name' => 'Croquetas de jamón', 'description' => 'Bechamel cremosa y jamón ibérico 36 meses.', 'price' => '9.50', 'image' => 'brasa-croquetas.jpg', 'allergens' => ['Gluten', 'Lácteos', 'Huevos'], 'video' => 'demo/reel-kitchen.mp4'],
    ['section' => 'Principales', 'name' => 'Solomillo al Pedro Ximénez', 'description' => 'Solomillo de ternera, reducción de Pedro Ximénez y patata confitada.', 'price' => '24.50', 'image' => 'brasa-solomillo.jpg', 'allergens' => ['Sulfitos'], 'highlight' => 'bestseller', 'video' => 'demo/reel-steak.mp4'],
    ['section' => 'Principales', 'name' => 'Lubina salvaje', 'description' => 'Verduras de temporada y emulsión de azafrán.', 'price' => '22.00', 'image' => 'brasa-lubina.jpg', 'allergens' => ['Pescados'], 'video' => 'demo/reel-03.mp4'],
...
$asadorDishes = [
    ['section' => 'De la brasa', 'name' => 'Chuletón madurado', 'description' => 'Ternera gallega 45 días, sal en escamas y chimichurri.', 'price' => '32.00', 'image' => 'brasa-solomillo.jpg', 'allergens' => [], 'highlight' => 'bestseller', 'video' => 'demo/reel-steak.mp4'],
    ['section' => 'De la brasa', 'name' => 'Entrecot a la brasa', 'description' => 'Corte grueso, marcado al carbón y mantequilla de hierbas.', 'price' => '26.50', 'image' => 'brasa-solomillo.jpg', 'allergens' => ['Lácteos'], 'highlight' => 'featured', 'video' => 'demo/reel-steak.mp4'],
    ['section' => 'De la brasa', 'name' => 'Morcilla de Burgos', 'description' => 'A la plancha con piquillo asado.', 'price' => '8.50', 'image' => 'brasa-croquetas.jpg', 'allergens' => [], 'video' => 'demo/reel-kitchen.mp4'],
    ...
    ['section' => 'Guarniciones', 'name' => 'Patata confitada', 'description' => 'Patata baby, ajo y romero.', 'price' => '5.50', 'image' => 'brasa-arroz-setas.jpg', 'allergens' => [], 'video' => 'demo/reel-04.mp4'],
];
...
function downloadCuratedAsset(string $imgRoot, string $relativePath, string $url, bool $keepExisting, int $minBytes = 8000): ?string
{
    ...
    if (! $data || strlen($data) < $minBytes) {
        ...
        return is_file($path) ? $relativePath : null;
    }
