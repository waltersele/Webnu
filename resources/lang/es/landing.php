...
return [
    ...
    'pricing' => [
        ...
        'pro' => [
            'name' => 'Pro',
            'tagline' => 'Carta digital completa. TVPik opcional desde 2 pantallas (misma tarifa que tvpik.es).',
            'price' => '9,90',
            'period' => '€ / mes · sin IVA',
            'cta' => 'Contratar Pro',
            'features' => [
                ...
                'Sin badge Webnu',
                'TVPik desde <strong>2 pantallas</strong> (add-on)',
            ],
        ],
        'plus' => [
            'name' => 'Plus',
            'tagline' => '19,90 € — carta ilimitada + 1 pantalla TV incluida.',
            'price' => '19,90',
            'period' => '€ / mes · sin IVA',
            ...
            'features' => [
                ...
                '<strong>1 pantalla TVPik</strong> incluida en el precio',
                'Sync automático TV',
                'Soporte prioritario',
                'Más pantallas con tramos TVPik (8/7/6 €)',
            ],
        ],
        'franchise' => [
            'name' => 'Franquicias',
    ...
    'faq' => [
        ...
        'items' => [
            ...
            ['q' => '¿Cómo funciona el idioma en la carta?', 'a' => 'Al crear la carta eliges el idioma principal (por defecto el de tu navegador). Desde Pro puedes tener hasta 3 idiomas en la carta (principal + 2 extras); con Plus, idiomas ilimitados. Traducción con IA o edición manual. Si el comensal tiene otro idioma activo, la carta se abre en ese idioma cuando lo tengas configurado.'],
