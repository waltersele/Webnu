...
<header class="fluid-container menu-header text-center" style="background:url('{{ $company->background_header != null ? URL::to('/').'/img/'.$company->background_header : URL::to('/').'/img/default-header.jpg' }}');">
    <div class="menu-overlay-header">
        <div class="menu-header-content">
            <div class="menu-logo-box text-center">
            ...
            <div class="menu-header-info container pb-4">
                @if($company->chef)
                <p class="chef">Chef:- {{ $company->chef_name }} -</p>
                @endif
                <a href="#footer" class="linkToInfo btn btn-warning mb-5">+ Información del negocio</a>
            </div>
        </div>
    </div>
</header>
...
<div class="container main-menu">
    @if (Session::has('table-reservation-ok'))
        <div class="alert alert-success" style="margin-top:20px;">
        <p>{{Session::get('table-reservation-ok') }}</p>
        </div>
    @endif
    @if (Session::has('table-reservation-failure'))
        <div class="alert alert-danger" style="margin-top:20px;">
        <p>{{ Session::get('table-reservation-failure') }}</p>
        </div>
    @endif
                ...
                @foreach ($section->products as $product)
                    <div class="menu-dishes-item">
                        <div class="row">
                            ...
                            <div class="col-4">
                                @include('themes.partials.product-media-trigger', ['product' => $product])
                            </div>
                            <div class="col-12">
                            ...
                            <hr class="divider">
                            <div class="col-12">
                                <div class="menu-dishes-allergic text-center">
