...
<style>
    ...
    /* ---------- Slide-up (feature) ---------- */
    /* Loop continuo, lento y con fade-out: el item saliente sube despacio
       y se desvanece a la vez que el entrante asoma desde abajo. */
    .hero-cycle--slide {
        overflow: hidden;
    ...
    .hero-cycle--slide .hero-cycle__item.is-active {
        transform: translateY(0);
        opacity: 1;
    }
    ...
    /* Hero — mockup móvil "Azul Coctelería" + chips flotantes */
    .hero-phone-stage {
        position: relative;
        padding: 1.5rem 0;
    }
    ...
    /* Chips flotantes alrededor del móvil */
    .hero-phone-chip {
        position: absolute;
        display: inline-flex;
        align-items: center;
    ...
    .hero-phone-chip__icon--accent {
        background: rgba(255, 255, 255, 0.18);
        color: #fff;
    }
    .hero-phone-chip__icon .material-symbols-outlined { font-size: 18px; }
    .hero-phone-chip--ticket {
        top: 14%;
        left: -8%;
        padding: 10px 14px;
        border-radius: 14px;
    ...
    .hero-phone-chip--ticket .hero-phone-chip__body {
        display: flex; flex-direction: column; line-height: 1;
    }
    .hero-phone-chip--ticket .hero-phone-chip__label {
        font-size: 0.625rem;
        font-weight: 700;
        letter-spacing: 0.16em;
        text-transform: uppercase;
    ...
    .hero-phone-chip--ticket .hero-phone-chip__value {
        margin-top: 4px;
        font-size: 1.125rem;
        font-weight: 800;
        color: #004ac6;
    }
    .hero-phone-chip--scan,
    .hero-phone-chip--translation {
    ...
    .hero-phone-chip--scan { bottom: 28%; left: -10%; }
    .hero-phone-chip--translation { top: 38%; right: -10%; }
    @media (max-width: 1023px) {
        /* Mantenemos el chip de ticket POR DEBAJO del notch del móvil para no taparlo */
        .hero-phone-chip--ticket { left: -2%; top: 22%; }
        .hero-phone-chip--scan { left: -2%; bottom: 18%; }
        .hero-phone-chip--translation { right: -2%; top: 42%; }
    }
    @media (max-width: 480px) {
        .hero-phone-stage { padding: 1rem 0; }
        .hero-phone { max-width: 280px; border-width: 8px; border-radius: 32px; }
        .hero-phone__notch { width: 80px; height: 18px; top: 6px; }
        .hero-phone-chip--ticket {
            left: -2%; top: 18%;
        ...
        .hero-phone-chip--scan {
            left: -2%; bottom: 10%;
            transform: scale(0.82); transform-origin: bottom left;
    ...
    /* TVPik unificado — slider con 5 plantillas TV (hero/tapas/daily/video/menu) */
    .landing-tv-show {
        position: relative;
        display: flex;
        flex-direction: column;
    ...
    .landing-tv-show__slide--daily {
        background: linear-gradient(160deg, #fff7e6 0%, #fed7aa 100%);
        color: #1f2937;
    }
    ...
    .landing-tv-show__slide--daily .landing-tv-show__title { color: #1f2937; }
    ...
    /* Video */
    .landing-tv-show__photo--video { filter: brightness(0.78); }
