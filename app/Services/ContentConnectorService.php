...

{
...

    {
        ...
        $this->assignCategory($post, (string) $payload['category_id']);

        $translation = $this->saveTranslation($post, $locale, $slug, $title, $content, $meta, null, $faqSchema);
...

    {
        ...
        $this->assignCategory($translation->post, (string) $payload['category_id']);
    ...
    private function assignCategory(BlogPost $post, string $categoryId): void
