...
class PlatformSettingsController extends Controller
{
    ...
    public function update(Request $request, PlatformSettingsService $settings)
    {
        ...
        $request->validate([
            ...
            'content_connector_secret' => 'nullable|string|min:16|max:500',
            'clear_content_connector_secret' => 'nullable|boolean',
        ...
        $settings->updateIntegrations(array_merge($request->only([
            ...
            'clear_content_connector_secret' => $request->boolean('clear_content_connector_secret'),
